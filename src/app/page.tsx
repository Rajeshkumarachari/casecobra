  ...
  return (
    <div className="bg-slate-50 ">
      ...
      <section className="bg-slate-100 py-2">
        <MaxWidthWrapper className="flex flex-col items-start gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-clos-2 gap-y-16 ">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8 ">
                <p>
                  ...
                  the design. Had the case for teo and a half months now and
                  {"  "}
                  <span className="mx-1 p-0.5 bg-slate-500 text-white rounded">
                    {" "}
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2 ">
                ...
                />
                <div className="flex flex-col">
                  <p className=" font-semibold"> Muni</p>
                  <div className="flex gap-1.5  items-center text-zinc-600">
                    <Check className=" size-4 stroke-[3px] text-green-600 " />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <img
                ...
                alt="arrow"
              />
              <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10  lg:rounded-xl">
                <img
                  src="/horse.jpg"
                  alt="horse"
